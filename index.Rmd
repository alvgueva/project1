...
innerdata %>% group_by(pvi_party) %>% ggplot(aes(pvi_amount,fill=pvi_party))+
  geom_density(alpha=0.6) + ggtitle("Partisan Voting Index Distribution by Party") + xlab("Partisan Voting Index") + scale_fill_brewer(palette="Dark2") + geom_vline(aes(xintercept = mean(pvi_amount), linetype="dashed"))
```
