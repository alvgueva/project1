...
```{bash, eval=F}
cd ~/project1 or ~/project2 #cd to your project1 and project2 directory
git add .
...
cd ~/project3 #cd to your project1 directory
git add .
git commit -m "message"
git remote set-url origin https://github.com/YOUR_USERNAME/project1.git
